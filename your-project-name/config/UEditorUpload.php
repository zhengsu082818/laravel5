...
*/
    ...
    'upload' => [
        ...
        "imagePathFormat" => "/storage/uploads/goods/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "filePathFormat" => "/storage/uploads/files/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "imageManagerListPath" => "/storage/uploads/goods/", /* 指定要列出图片的目录 */
        ...
        "fileManagerListPath" => "/storage/uploads/files/", /* 指定要列出文件的目录 */
