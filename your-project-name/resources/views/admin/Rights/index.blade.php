  ...
  @section('content')
   <div class="x-body">
    ...
    <div class="x-body">
         ...
         <a href="{{url('admin/role/create')}}" style="color:#fff;"><span class="x-left layui-btn" style="line-height:40px">添加职位</span></a>
      ...
      <table class="layui-table">
        ...
        <thead>
          <tr >
            ...
            <th style="text-align: center;">职位展示名称</th>
          ...
          @foreach ($role as $v)
              <tr>
                ...
                <td class="td-manage" style="text-align: center;">
                  <a href='{{url("admin/role/edit/$v->id")}}' style="color:#fff;">
                    <button class="layui-btn layui-btn-mini">修改</button>
                  </a>
                  <a href='{{url("admin/role/destroy/$v->id")}}' style="color:#fff;">
